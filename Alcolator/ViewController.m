...
@interface ViewController () <UITextFieldDelegate>
    ...
    // NOTE: commented out on own, may need to reactivate
    //@property (weak, nonatomic) UIButton *calculateButton;
    //@property (weak, nonatomic) UITapGestureRecognizer *hideKeyboardTapGestureRecognizer;

    @property (weak, nonatomic) UILabel *beersSelected;
...
- (void) viewWillLayoutSubviews {
    ...
    self.beersSelected.frame = CGRectMake(padding, bottomOfSlider + padding, itemWidth, itemHeight);
    
    CGFloat bottomOfBeersSelected = CGRectGetMaxY(self.beersSelected.frame);
    self.resultLabel.frame = CGRectMake(padding, bottomOfBeersSelected + padding, itemWidth, itemHeight);
    
    CGFloat bottomOfLabel = CGRectGetMaxY(self.resultLabel.frame);
    self.calculateButton.frame = CGRectMake(padding, bottomOfLabel + padding, itemWidth, itemHeight);
    
//    CGFloat bottomOfButton = CGRectGetMaxY(self.calculateButton.frame);
...
- (void)viewDidLoad {
    ...
    self.beerPercentTextField.backgroundColor = [UIColor grayColor];
    self.beerPercentTextField.textColor = [UIColor lightTextColor];
    self.resultLabel.textColor = [UIColor lightTextColor];
    self.beersSelected.textColor = [UIColor lightTextColor];
